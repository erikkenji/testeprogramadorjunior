                ...
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="titulo" name="titulo">
                            ...
                            <option <% 
                            	if(professor!=null && professor.getTitulacao().equals("Mestre")){
                            		out.println(" selected='selected'");
                            	}
                            %>>Mestre</option>
                            <option <% 
                            	if(professor!=null && professor.getTitulacao().equals("Doutor(a)")){
                            		out.println(" selected='selected'");
                            	}
                            %>>Doutor(a)</option>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" id="txtEmail" name="txtEmail" aria-describedby="emailHelp"
                        	...
                        	if(professor!=null){
                				out.println(professor.getEmail());
                			}
                        %>">
                    ...
                    <div id="telefones">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="validationTooltipUsernamePrepend">Celular</span>
                                </div>
                                <input type="phone" class="form-control" id="telefone" name="telefone[Celular][]" aria-describedby="phoneHelp"
                                    placeholder="Digite um telefone" value="(11) 96633-6626">
                                <div class="input-group-append">
                                    <button type="button" class="btn btn-danger removerTelefone"><span class="oi oi-minus"></span></button>
                                </div>
                            </div>
                    ...
                    <a href="professores.jsp" class="btn btn-secondary">Cancelar</a>
